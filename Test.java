...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Fish fh1 = new Fish(10, "aaa", "SUperDriver", "Rare",100);
        System.out.println(fh1);
        System.out.println("\n Vlue of this is : "+ fh1.getVolum()+" Milion \n");
        
        Fish fh2 = new Fish(10, "aaa", "SUperDriver", "Rare",100);
        System.out.println(fh1);
        System.out.println("\n Vlue of this is : "+ fh1.getVolum()+" Milion \n");
       ...
       Animals br2 = new Animals();
        ...
        System.out.println(fh1.equals(br1));
        
         System.out.println(fh1.equals(fh2));
    }
}
